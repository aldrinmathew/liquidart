...
///
/// This mixin is typically used with [TestHarnessORMMixin] and `package:liquidart/managed_auth`.
...
abstract class TestHarnessAuthMixin<T extends ApplicationChannel>
  ...
  Future<Agent> addClient(String id,
      {String? secret, String? redirectUri, List<String> allowedScope = const []}) async {

...
/// The `liquid db` tool will create database tables for these types as long as they are visible
/// to the application's library file, as noted above.
library liquid.managed_auth;
...
/// code flow.
///
/// Use the `liquid auth` tool to add new clients to an application.

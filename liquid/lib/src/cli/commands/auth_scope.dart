...
import 'package:liquid/managed_auth.dart';
...
class CLIAuthScopeClient extends CLICommand
  ...
  String get description {
    return "Sets the scope of an existing OAuth 2.0 client in a database that has been provisioned with the liquid/managed_auth package.";
  }
}

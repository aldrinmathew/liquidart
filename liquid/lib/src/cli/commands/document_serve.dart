...
import 'package:liquid/src/http/http.dart';
...
class CLIDocumentServe extends CLICommand with CLIProject, CLIDocumentOptions {
  ...
  Directory get _hostedDirectory =>
      Directory.fromUri(projectDirectory.uri.resolve(".liquid_spec"));
...
<html>
  ...
  String get detailedDescription {
    return "This tool will start an HTTP server that serves an API reference web page. See `liquid document --help` for configuration options.";
  }
}

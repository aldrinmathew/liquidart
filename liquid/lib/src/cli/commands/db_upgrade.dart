...
import 'package:liquid/src/cli/mixins/database_connecting.dart';
import 'package:liquid/src/cli/mixins/database_managing.dart';
import 'package:liquid/src/cli/mixins/project.dart';
import 'package:liquid/src/cli/scripts/run_upgrade.dart';
import 'package:liquid/src/db/postgresql/postgresql_persistent_store.dart';
import 'package:liquid/src/db/query/query.dart';
import 'package:liquid/src/cli/migration_source.dart';
import 'package:liquid/src/db/schema/schema.dart';
...
class CLIDatabaseUpgrade extends CLICommand
  ...
  Future<int> handle() async {
    ...
    if (migrations.isEmpty) {
      ...
      displayProgress("Run 'liquid db generate' first.");
      return 0;
    }

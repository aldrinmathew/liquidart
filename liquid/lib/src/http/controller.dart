...
abstract class Controller
  ...
  ///
  /// By default, this is false. During debugging, setting this to true can help debug Liquid applications
  ...
  /// An instance of the 'liquid' logger.
  Logger get logger => Logger("liquid");

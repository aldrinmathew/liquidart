...
import 'package:liquid/src/auth/auth.dart';
...
///         }
///
/// Bindings will automatically parse values into other types and validate that requests have the desired values. See [Bind] for all possible bindings and https://liquid.io/docs/http/resource_controller/ for more details.
///

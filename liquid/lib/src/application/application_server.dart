...
///
/// An Liquid application creates instances of this type to pair an HTTP server and an
...
class ApplicationServer {
  ...
  Future didOpen() async {
    server.serverHeader = "liquid/$identifier";
    ...
    logger.info("Server liquid/$identifier started.");
  }

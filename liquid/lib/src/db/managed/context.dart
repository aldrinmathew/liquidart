...
import 'package:liquid/src/application/service_registry.dart';
import 'package:liquid/src/db/managed/data_model_manager.dart';
...
///
/// You create objects of this type to use the Liquid ORM. Create instances in [ApplicationChannel.prepare]

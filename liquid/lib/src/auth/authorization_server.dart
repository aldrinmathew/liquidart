...
/// implementation like `ManagedAuthDelegate` from `package:liquid/managed_auth.dart`.
///
...
class AuthServer implements AuthValidator, APIComponentDocumenter {
  ...
  ///
  /// It is preferable to use the implementation of [AuthServerDelegate] from 'package:liquid/managed_auth.dart'. See
  ...
  void documentComponents(APIDocumentContext context) {
    final basic = APISecurityScheme.http("basic")
      ..description =
          ...
          "If the client ID does not have a secret (public client), the password is the empty string (retain the separating colon, e.g. 'com.liquid.app:').";

...
///
/// See the liquid/managed_auth library for a concrete implementation of this type.
///
/// Use the command line tool `liquid auth` to create instances of this type and store them to a database.
class AuthClient {
...
///
/// See the `package:liquid/managed_auth` library for a concrete implementation of this type.
class AuthToken {
...
///
/// An [AuthClient] has a list of valid scopes (see `liquid auth` tool). An access token issued for an [AuthClient] may ask for

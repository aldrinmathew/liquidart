...
void main() {
  group("Documentation", () {
    ...
    setUpAll(() async {
      ...
      idOperations =
          c.documentOperations(context, "/", APIPath(parameters: [APIParameter.path("id")]));
    ...
    test("getObject", () {
      ...
      expect(op.responses["200"].content["application/json"].schema.referenceURI.path,
    ...
    test("createObject", () {
      ...
      expect(op.responses["200"].content["application/json"].schema.referenceURI.path,
          "/components/schemas/TestModel");
      expect(op.requestBody.content["application/json"].schema.referenceURI.path,
          "/components/schemas/TestModel");
    });
    ...
    test("getObjects", () {
      ...
      expect(op.responses["200"].content["application/json"].schema.items.referenceURI.path,
          "/components/schemas/TestModel");
    });
  });
}

...
void main() {
  ...
  test("Including RelationshipInverse property can only be done by using name of property",
      () async {
    context = await contextWithModels([GenUser, GenPost]);
  ...
  group("Fetch by id", () {
    ...
    test("If identifier type is not the same type as return type, throw exception with 404",
        () async {

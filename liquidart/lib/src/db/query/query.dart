...
abstract class Query<InstanceType extends ManagedObject> {
  ...
  factory Query(ManagedContext context, {InstanceType? values}) {
    final ManagedEntity? entity =
        context.dataModel!.entityForType(InstanceType);
    if (entity == null) {
      throw ArgumentError(
  ...
  ///           ..join(set: (u) => u.notes);
  ///
  /// This method also returns a new instance of [Query], where [InstanceType] is the type of the relationship property. This can be used

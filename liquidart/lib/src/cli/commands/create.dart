...
/// Used internally.
class CLITemplateCreator extends CLICommand with CLILiquidartGlobal {
  CLITemplateCreator() {
  ...
  Future<int> handle() async {
    if (projectName == null) {
      printHelp(parentCommandName: "liquidart");
      return 1;
    }
  ...
  String get detailedDescription {
    return "This command will use a template from the liquidart package determined by either "
  ...
  String get description {
    return "Creates Liquidart applications from templates.";
  }
}

class CLITemplateList extends CLICommand with CLILiquidartGlobal {
  @override
  Future<int> handle() async {
  ...
  @override
  String get description {
    return "List Liquidart application templates.";
  }

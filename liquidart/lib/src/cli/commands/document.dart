...
import 'package:liquidart/src/cli/commands/oai_client.dart';
import 'package:liquidart/src/cli/mixins/openapi_options.dart';
import 'package:liquidart/src/cli/mixins/project.dart';

import 'package:liquidart/src/cli/command.dart';
import 'package:liquidart/src/cli/commands/document_serve.dart';
import 'package:liquidart/src/cli/scripts/openapi_builder.dart';
...
class CLIDocument extends CLICommand with CLIProject, CLIDocumentOptions {
  ...
  String get detailedDescription {
    return "This tool will generate an OpenAPI specification of an Liquidart application. It operates by invoking Application.document. "

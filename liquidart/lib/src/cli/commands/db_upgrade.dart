...
import 'package:liquidart/src/cli/mixins/database_connecting.dart';
import 'package:liquidart/src/cli/mixins/database_managing.dart';
import 'package:liquidart/src/cli/mixins/project.dart';
import 'package:liquidart/src/cli/scripts/run_upgrade.dart';
...
class CLIDatabaseUpgrade extends CLICommand
  ...
  Future<int> handle() async {
    ...
    if (migrations.isEmpty) {
      ...
      displayProgress("Run 'liquidart db generate' first.");
      return 0;
    }
  ...
  Future<Schema> executeMigrations(
      List<MigrationSource> migrations, Schema fromSchema, int fromVersion) async {

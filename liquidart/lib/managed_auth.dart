...
/// The `liquidart db` tool will create database tables for these types as long as they are visible
/// to the application's library file, as noted above.
library liquidart.managed_auth;
...
class ManagedAuthDelegate<T extends ManagedAuthResourceOwner>
  ...
  Future addToken(AuthServer server, AuthToken token,
    ...
    if (issuedFrom != null) {
      ...
      final ManagedAuthToken? outToken = await query.updateOne();
      if (outToken == null) {
